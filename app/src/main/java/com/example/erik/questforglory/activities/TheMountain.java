...
public class TheMountain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        golemHealth = (TextView) findViewById(R.id.golemHealth);
        ...
        golemDefeatedGrid = (TextView) findViewById(R.id.golemDefeatedGrid);
        golemDefeated = (TextView) findViewById(R.id.golemDefeated);
